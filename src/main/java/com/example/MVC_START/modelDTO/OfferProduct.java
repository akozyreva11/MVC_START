...
public class OfferProduct {
    ...
    public static final String TEXT_TOP_SAVING = "Откройте свою собственную «Копилку» с нашим банком! «Копилка» — это уникальный " +
    ...
    public static final String TEXT_INVEST_500 = "Откройте свой путь к успеху с индивидуальным инвестиционным " +
    ...
    public static final String TEXT_SIMPLE_LOAN = "Откройте мир выгодных кредитов с нами!" +
